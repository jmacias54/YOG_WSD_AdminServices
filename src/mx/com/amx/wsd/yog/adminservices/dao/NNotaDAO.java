...
private static Logger logger = Logger.getLogger(NNotaDAO.class);
	...
	public List<ItemsResponse> getListItemsByFilter(ItemsFilterRequest req) throws DAOException {
		logger.debug(" --- getListItemsByFilter  [ NNotaDAO ]  --- " );
		...
		query.append(" 				FROM  yog_ba_n_nota n       ");
		...
		try {
			...
			logger.error(" --- Error getListItemsByFilter  [ NNotaDAO ] : ", e);
	...
	public List<ItemsResponse> getListItemsByTitle(ItemsRequestByTitle req) throws DAOException {
		logger.debug(" --- getListItemsByTitle  [ NNotaDAO ]  --- " );
		logger.debug(" --- request :  "+req.toString()+"  --- " );
		...
		try {
			...
			logger.error(" ---  Error getListItemsByTitle  [ NNotaDAO ] : ", e);
	...
	public List<ItemsResponse> getListItems(ItemsRequest req) throws DAOException {
		logger.debug(" --- getListItems  [ NNotaDAO ]  --- " );
		logger.debug(" --- request :  "+req.toString()+"  --- " );
		...
		try {
			...
			logger.error("---  Error getListItems  [ NNotaDAO ] :", e);
